...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__48.appendChild(me._container_2);
		...
		me.__6.logicBlock_position = function() {
			...
			if (me.__6.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__6.style.transition='right 0s, top 0s, transform 0s';
				if (me.__6.ggCurrentLogicStatePosition == 0) {
					me.__6.style.right='2px';
					me.__6.style.top = 'calc(50% - (483px / 2) + (0px / 2) + 5px)';
				}
				else {
					me.__6.style.right='15px';
					me.__6.style.top='calc(50% - ((483px + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me.__43.appendChild(me._timer_1);
		...
		me._on.onclick=function (e) {
			...
			if (
				...
				player.openNext("{node79}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\uc8fc\ubc291")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node80}","$(cur)");
			}
			if (
				(
			...
			if (
				...
				player.openNext("{node85}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\uac70\uc2e44")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node86}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\uac70\uc2e4\uc911\uc559")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node87}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\ub4dc\ub808\uc2a4\ub8f81")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node88}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\ub4dc\ub808\uc2a4\ub8f82")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node89}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\ub4dc\ub808\uc2a4\ub8f83")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node90}","$(cur)");
			}
			if (
				(
			...
			if (
				...
				player.openNext("{node93}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\uce68\uc2e44")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node94}","$(cur)");
			}
			if (
				(
					((player._(me.ggUserdata.comment) == "\uce68\uc2e4\uc911\uc559")) && 
					((me.ggUserdata.tags.indexOf("38A") != -1))
				)
			) {
				player.openNext("{node95}","$(cur)");
			}
			if (
				(
		...
		me.__32.logicBlock_text = function() {
			...
			if (me.__32.ggCurrentLogicStateText != newLogicStateText) {
				me.__32.ggCurrentLogicStateText = newLogicStateText;
				me.__32.style.transition='';
				if (me.__32.ggCurrentLogicStateText == 0) {
					if (me.__32.ggUpdateText) {
					me.__32.ggUpdateText=function() {
						var params = [];
					...
					me.__32.ggUpdateText();
						...
						if (me.__32.ggUpdatePosition) me.__32.ggUpdatePosition();
					}
				}
				else {
					if (me.__32.ggUpdateText) {
		...
		me.__32.logicBlock_text();
		me.__32.ggUpdatePosition=function (useTransition) {
		}
		me._onoff.appendChild(me.__32);
		me.__9.appendChild(me._onoff);
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		me.__11.onmousemove=function (e) {
		...
		me.__10.ggIsActive=function() {
			return (me.__10.ggTimestamp==0 ? false : (Math.floor((skin.ggCurrentTime - me.__10.ggTimestamp) / me.__10.ggTimeout) % 2 == 0));
		}
		el.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
		...
		me._rectangle_2.appendChild(me.__9);
		me.__6.appendChild(me._rectangle_2);
		...
		me.__8.logicBlock_position = function() {
			...
			if (me.__8.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__8.style.transition='left 500ms ease 500ms, top 500ms ease 500ms, opacity 500ms ease 0ms';
				if (me.__8.ggCurrentLogicStatePosition == 0) {
					me.__8.style.left='-10px';
					me.__8.style.top = 'calc(50% - (43px / 2))';
				}
				else if (me.__8.ggCurrentLogicStatePosition == 1) {
					me.__8.style.left='20px';
					me.__8.style.top = 'calc(50% - (43px / 2))';
				}
				else {
					me.__8.style.left='0px';
					me.__8.style.top='calc(50% - ((43px + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me.__8.logicBlock_alpha = function() {
			...
			if (me.__8.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				else if (me.__8.ggCurrentLogicStateAlpha == 1) {
		...
		me.__8.appendChild(me._rectangle_3);
		...
		me.__.logicBlock_position = function() {
			...
			if (me.__.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__.style.transition='right 500ms ease 0ms, bottom 500ms ease 0ms';
		...
		el.ggUpdate = function(filter) {
			if(me.__3.ggUpdating == true) return;
			me.__3.ggUpdating = true;
			var el=me.__3;
			var curNumRows = 0;
			curNumRows = me.__3.ggNumRepeat;
			...
			var centerOffsetVert = 0;
				me.__3.ggCloneOffsetChanged = false;
			}
			...
			tourNodes = me.__3.getFilteredNodes(tourNodes, filter);
			me.__3.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__3.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__3.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__3.ggWidth) + 'px';
				parameter.width=me.__3.ggWidth + 'px';
				parameter.height=me.__3.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__3_Class(nodeId, me, el, parameter);
				currentIndex++;
			...
			me.__3.ggNodeCount = me.__3.ggNumFilterPassed;
			me.__3.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__3.parentNode && me.__3.parentNode.classList.contains('ggskin_subelement') && me.__3.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__3.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "가구있음";
		el.ggFilter[1] = "메인";
		...
		me.__3.ggCurrentLogicStateSize = -1;
		me.__3.ggCurrentLogicStateVisible = -1;
		me.__3.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__3.childNodes.length; i++) {
				var child=me.__3.childNodes[i];
		...
		el.ggUpdate = function(filter) {
			if(me.__1.ggUpdating == true) return;
			me.__1.ggUpdating = true;
			var el=me.__1;
			var curNumRows = 0;
			curNumRows = me.__1.ggNumRepeat;
			if (curNumRows < 1) curNumRows = 1;
			if (typeof filter=='object') {
				el.ggFilter = filter;
			} else {
			...
			var centerOffsetHor = 0;
			var centerOffsetVert = 0;
				me.__1.ggCloneOffsetChanged = false;
			}
			el.ggCurrentFilter = filter;
			el.ggInstances = [];
			if (el.hasChildNodes() == true) {
			...
			var currentIndex = 0;
			var keepCloning = true;
			tourNodes = me.__1.getFilteredNodes(tourNodes, filter);
			me.__1.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__1.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__1.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__1.ggWidth) + 'px';
				parameter.width=me.__1.ggWidth + 'px';
				parameter.height=me.__1.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__1_Class(nodeId, me, el, parameter);
				currentIndex++;
				el.ggInstances.push(inst);
				el.appendChild(inst.__div);
				inst.__div.ggObj=inst;
			...
			me.__1.ggNodeCount = me.__1.ggNumFilterPassed;
			me.__1.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__1.parentNode && me.__1.parentNode.classList.contains('ggskin_subelement') && me.__1.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__1.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "가구없음";
		el.ggFilter[1] = "메인";
		...
		me.__1.ggCurrentLogicStateSize = -1;
		me.__1.ggCurrentLogicStateVisible = -1;
		me.__1.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__1.childNodes.length; i++) {
				var child=me.__1.childNodes[i];
				if (child.ggObj && child.ggObj.ggNodeId==cnode) {
			        var childOffX = child.offsetLeft;
			        var childOffY = child.offsetTop;
					var p = child.parentElement;
		...
		me._scrollarea_1__content.appendChild(me.__0);
		...
		me.__18a.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.ggUserdata.tags.indexOf("18A") != -1))
			)
			...
			if (me.__18a.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__18a.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__18a.style.transition='';
				if (me.__18a.ggCurrentLogicStateVisible == 0) {
					me.__18a.style.visibility=(Number(me.__18a.style.opacity)>0||!me.__18a.style.opacity)?'inherit':'hidden';
					me.__18a.ggVisible=true;
				}
				else {
					me.__18a.style.visibility="hidden";
					me.__18a.ggVisible=false;
				}
			}
		}
		me.__18a.logicBlock_visible();
		...
		me.__.appendChild(me._scrollarea_1);
		...
		player.addListener('changenode', function(event) {
			...
			me.__0.logicBlock_visible();
			me.__3.logicBlock_visible();
			me.__3.ggUpdateConditionNodeChange();
			me.__1.logicBlock_visible();
		...
		player.addListener('sizechanged', function(event) {
			...
			for(var i = 0; i < me.__1.ggInstances.length; i++) {
				me.__1.ggInstances[i].ggEvent_sizechanged(event);
			}
			for(var i = 0; i < me.__3.ggInstances.length; i++) {
				me.__3.ggInstances[i].ggEvent_sizechanged(event);
			}
			me.__55.logicBlock_position();
			me.__55.logicBlock_size();
			me.__55.logicBlock_scaling();
	...
	function SkinCloner__1_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
	...
	function SkinCloner__3_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		me._rectangle_10.appendChild(me.__4);
	...
	me.skinTimerEvent=function() {
		...
		var hs='';
		if (me.__46.ggParameter) {
			hs+=parameterToTransform(me.__46.ggParameter) + ' ';
		}
		hs+='translate(' + (1 * player.mouse.x + -35) + 'px,0px) ';
		hs+='translate(0px,' + (1 * player.mouse.y + 20) + 'px) ';
		me.__46.style.transform=hs;
		...
		if (me.__10.ggLastIsActive!=me.__10.ggIsActive()) {
			me.__10.ggLastIsActive=me.__10.ggIsActive();
			if (me.__10.ggLastIsActive) {
				me.__12.style.transition='none';
				me.__12.style.visibility='hidden';
				me.__12.ggVisible=false;
			} else {
